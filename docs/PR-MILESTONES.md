...
| Release 0.2.0 | Formal release | Version bump `0.2.0-alpha.1 → 0.2.0`, CHANGELOG formal entry, README/milestones updated; tag and GitHub Release created from the verified main commit. |
