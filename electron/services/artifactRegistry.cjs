...
const CLONE_FIELD_SCHEMA = Object.freeze({
  ...
  'underlay-critique': Object.freeze({ references: Object.freeze(['underlay', 'underlay_contract', 'visual_results_id', 'critique_id']) }),
  ...
  'composition-manifest': Object.freeze({ references: Object.freeze(['visual_results', 'visual_results_id', 'selected_variation_ids', 'underlay', 'critique_id', 'approved_layout', 'style_contract']) }),
  'composition-output': Object.freeze({ references: Object.freeze(['composition_manifest', 'underlay', 'variation_id']) }),
  'fidelity-report': Object.freeze({ references: Object.freeze(['composition_manifest', 'composition_output']) }),
